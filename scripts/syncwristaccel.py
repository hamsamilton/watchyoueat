...
DATA_FOLDER = os.path.join(os.getcwd(),SUBJ,'In Wild',DEVICE,'Clean','Resampled','Accelerometer',DATE,HOUR) 
file = 'accel_data.csv'
...
for episode in SETTINGS:
	...
	newDataPath = os.path.join(NEW_FOLDER, SUBJ + DEVICE + DATE + HOUR + file)
